...
/**
 * Created by Rachel on 06/05/2017.
 */
...
public final class QueryUtils {
    ...
    /**
     * Query the USGS dataset and return  an array of earthquake.
     */
    public static ArrayList<EarthQuakeData> fetchEarthquakeData(String requestUrl) {
        ...
        try {
            ...
            Log.v(LOG_TAG,"makehttprequest is called");
        } catch (IOException e) {
       ...
       ArrayList<EarthQuakeData> earthquake = extractEarthquakes(jsonResponse);
        ...
        // Return the list of earth quakes
        return earthquake;
    }
    ...
    public static ArrayList<EarthQuakeData> extractEarthquakes(String JsonResponse) {
        ...
        try {
            JSONObject read = new JSONObject(JsonResponse);
            JSONArray features = read.getJSONArray("features");
